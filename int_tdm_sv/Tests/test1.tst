...
<id>13942A11C2AC11E7B84ED8CB8A8AB1DA</id>
...
<deletedProps>
    ...
    <Node name="Web Service" log=""
          ...
          version="1" 
          uid="4B04F985C2AC11E7B84ED8CB8A8AB1DA" 
          think="500-1S" 
          useFilters="true" 
          quiet="false" 
          next="end" > 
...
<mtom-paths>
    ...
    <Node name="abort" log=""
          ...
          version="1" 
          uid="13942A13C2AC11E7B84ED8CB8A8AB1DA" 
          think="0h" 
          useFilters="true" 
          quiet="true" 
          next="" > 
    ...
    <Node name="fail" log=""
          ...
          version="1" 
          uid="13942A15C2AC11E7B84ED8CB8A8AB1DA" 
          think="0h" 
          useFilters="true" 
          quiet="true" 
          next="abort" > 
    ...
    <Node name="end" log=""
          ...
          version="1" 
          uid="13942A17C2AC11E7B84ED8CB8A8AB1DA" 
          think="0h" 
          useFilters="true" 
          quiet="true" 
          next="fail" > 
